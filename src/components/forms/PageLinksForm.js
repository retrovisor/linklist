...
{showDeleteConfirmation && (
  <div className="fixed z-10 inset-0 overflow-y-auto">
    <div className="flex items-center justify-center px-4 text-center">
      ...
      <div className="inline-block align-middle bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all mt-32 sm:mt-0 sm:max-w-lg sm:w-full">
